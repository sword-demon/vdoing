...
module.exports = {
    ...
    repo: 'https://github.com/sword-demon', // 导航栏右侧生成Github链接
    ...
    author: {
        ...
        name: 'wxvirus', // 必需
        link: 'https://github.com/sword-demon', // 可选的
    },
    blogger: {
        // 博主信息，显示在首页侧边栏
        avatar: '/img/avatar.jpeg',
        name: '无解的lifecycle',
        slogan: 'let today = new Beginning()',
    },
    social: {
        // 社交图标，显示于博主信息栏和页脚栏
    ...
    footer: {
        ...
        copyrightInfo: 'wxvirus', // 博客版权信息，支持a标签
    },
